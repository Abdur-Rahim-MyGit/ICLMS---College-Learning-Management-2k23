...
if (isset($_POST['upload'])) {
	...
	$q = "INSERT INTO `attendance`(`title`, `pdf`, `year`,`department`,`group`) VALUES ('$title','$file_name','$year','$department','$group')";

	if(mysqli_query($conn,$q)) {

		header("location: attendance.php?msg=pdf Added Successfully");
	}
	else {
...
<html lang="en">
  ...
  <body>
  <div class="container">
    <div class="title">Add New-Attendance</div>
    <div class="content">
      <div class="Rahim">

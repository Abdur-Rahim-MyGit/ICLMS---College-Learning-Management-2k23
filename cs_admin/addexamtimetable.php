...
if (isset($_POST['upload'])) {
	...
	$q = "INSERT INTO `examtime`(`title`, `pdf`, `year`,`department`,`group`) VALUES ('$title','$file_name','$year','$department','$group')";

	if(mysqli_query($conn,$q)) {

		header("location: examtime.php?msg=pdf Added Successfully");
	}
	else {
...
<html lang="en">
  ...
  <body>
  <div class="container">
    <div class="title">Add New-Exam-TimeTable</div>
    <div class="content">
      <div class="Rahim">
      <form action="addexamtimetable.php" method="post" enctype="multipart/form-data">
        ...
        <div class="button">
          <input type="submit" name="upload" value="Add Exam-TimeTable" >
        </div>
      </form>
    </div>
  </div>

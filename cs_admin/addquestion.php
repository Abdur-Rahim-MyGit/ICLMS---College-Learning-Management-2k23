...
if (isset($_POST['upload'])) {
	...
	$q = "INSERT INTO `question`(`title`, `pdf`, `year`,`department`,`group`) VALUES ('$title','$file_name','$year','$department','$group')";

	if(mysqli_query($conn,$q)) {

		header("location: questionbank.php?msg=pdf Added Successfully");
	}
	else {

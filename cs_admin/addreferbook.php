...
if (isset($_POST['upload'])) {
	...
	$q = "INSERT INTO `books`(`title`, `pdf`, `year`,`department`,`group`) VALUES ('$title','$file_name','$year','$department','$group')";

	if(mysqli_query($conn,$q)) {

		header("location: ReferBook.php?msg=pdf Added Successfully");
	}
	else {
...
<html lang="en">
  ...
  <div class="container">
    ...
    <div class="content">
      <div class="Rahim">
      <form action="addreferbook.php" method="post" enctype="multipart/form-data">

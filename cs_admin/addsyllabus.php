...
if (isset($_POST['upload'])) {
	...
	$q = "INSERT INTO `syllabus`(`title`, `pdf`, `year`,`department`,`group`) VALUES ('$title','$file_name','$year','$department','$group')";

	if(mysqli_query($conn,$q)) {

		header("location: Syllabus.php?msg=pdf Added Successfully");
	}
	else {
...
<html lang="en">
  ...
  <body>
  <div class="container">
    <div class="title">Add New-Syllabus</div>
    <div class="content">
      <div class="Rahim">
      <form action="addsyllabus.php" method="post" enctype="multipart/form-data">
        ...
        <div class="button">
          <input type="submit" name="upload" value="Add Syllabus" >
        </div>
      </form>
    </div>
  </div>

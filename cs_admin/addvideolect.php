...
if (isset($_POST['upload'])) {
	...
	$q = "INSERT INTO `videos`(`title`, `video`, `year`,`department`,`group`) VALUES ('$title','$file_name','$year','$department','$group')";

	if(mysqli_query($conn,$q)) {

		header("location: videolect.php?msg=pdf Added Successfully");
	}
	else {
...
<html lang="en">
  ...
  <div class="container">
    ...
    <div class="content">
      <div class="Rahim">
      <form action="addvideolect.php" method="post" enctype="multipart/form-data">
        <div class="user-details">
          ...
          <div class="input-box" >
            ...
            <input type="file" name="file" class="makeme" placeholder="Choose Your Video" required>
          </div>
          <div class="input-box">

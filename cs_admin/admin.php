...
<body>
    ...
    <?php require 'partials/top_nav.php'?>
     ...
     <?php
        ...
        ?>
            <a href="add_new.php" class="btn btn-dark mb-2" style="margin-left: 528px; background-color : rgba(227 216 253 / 35%);">Add New</a>
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            ?>
                              <tr >
                                  ...
                                  <td>
                                    <a href="edit.php?id=<?php echo $row['s.no'] ?>" class="link-light"><i class="fa-solid fa-pen-to-square fs-6 me-3"></i></a>
                                    <a href="delete.php?id=<?php echo $row['s.no'] ?>" class="link-light"><i class="fa-solid fa-trash fs-6 me-3"></i></a>
                                </td>
                              </tr>
                        <?php        
                    }

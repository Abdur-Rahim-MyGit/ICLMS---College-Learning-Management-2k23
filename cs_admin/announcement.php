...
<body>
      ...
      <?php
        ...
        ?>
     <a href="addannouncement.php" class="btn btn-dark mb-2" style="margin-left: 528px; margin-top:80px; background-color : rgba(227 216 253 / 35%);">Add New</a>
                ...
                <table id="example" class="table table-striped"> <br>
                    ...
                    <?php
                        ...
                        <tr >
                            ...
                            <td>
                                <a href="editannouncement.php?id=<?php echo $row['id'] ?>" class="link-light"><i class="fa-solid fa-pen-to-square fs-6 me-3"></i></a>
                                <a href="deleteannouncement.php?id=<?php echo $row['id'] ?>" class="link-light"><i class="fa-solid fa-trash fs-6 me-3"></i></a>
                            </td>
                        </tr>
                        <?php        
                    }

...
if(isset($_POST['upload'])){
    ...
    $sql = "UPDATE `calender` SET `name`='$name',`date`='$date',`description`='$description',`type`='$type' WHERE `id`=$id";

    $result = mysqli_query($conn, $sql);

    if($result){
        header("location: calender.php?msg=Record has been updated successfully");
    }
    else {
      ...
      <form action="" method="post">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" value="<?php echo $row['type'] ?>" id="type" name="type" required>
          </div>
        </div>
        <div class="button">

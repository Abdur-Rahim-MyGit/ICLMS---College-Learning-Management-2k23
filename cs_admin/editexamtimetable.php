...
<html lang="en">
  ...
  <body>
<div class="container">
    <div class="title">Update ExamTimeTable</div>
    <?php 
        require "partials/_dbconnect.php";
        // echo '$_GET[`id`]';
        $id = $_GET['id'];
        $sql = "SELECT * FROM `examtime` where `id`=$id";
    ...
    <div class="content">
      ...
      <form action="code.php" method="post" enctype="multipart/form-data">
        <div class="user-details">
          <input type="hidden" name="examtimetable_id" value="<?php echo $row['id'] ?>">
          <div class="input-box">
          ...
          <div class="input-box" >
            ...
            <input type="hidden" name="examtimetable_old" value="<?php echo $row['pdf'];?>">
          </div>
          <!-- <img src="<?php echo "photo/".$row['image'];?>" width="100px" alt=""> -->
          <iframe src="<?php echo "Pdf/".$row['pdf'];?>" width="100px" frameborder="0"></iframe>
        </div>
        <div class="button">
          <input type="submit" name="examtimetable_upload" value="Update" >
        </div>
      </form>
    </div>
  </div>

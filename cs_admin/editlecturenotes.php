...
<html lang="en">
  ...
  <body>
<div class="container">
    <div class="title">Update Notes</div>
    <?php 
    ...
    <div class="content">
      ...
      <form action="code.php" method="post" enctype="multipart/form-data">
        <div class="user-details">
          <input type="hidden" name="notes_id" value="<?php echo $row['id'] ?>">
          <div class="input-box">

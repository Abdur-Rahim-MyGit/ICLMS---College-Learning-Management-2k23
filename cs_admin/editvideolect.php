...
<html lang="en">
  ...
  <body>
<div class="container">
    <div class="title">Update Video Lecture</div>
    <?php 
    ...
    <div class="content">
      ...
      <form action="code.php" method="post" enctype="multipart/form-data">
        <div class="user-details">
          <input type="hidden" name="videos_id" value="<?php echo $row['id'] ?>">
          <div class="input-box">
          ...
          <div class="input-box" >
            ...
            <input type="file" name="file" class="makeme" placeholder="Choose Your Pdf">
            <input type="hidden" name="videos_old" value="<?php echo $row['video'];?>">
          </div>
          <!-- <img src="<?php echo "photo/".$row['image'];?>" width="100px" alt=""> -->
          <iframe src="<?php echo "Video/".$row['video'];?>" width="200px" height="100px" frameborder="0"></iframe>
        </div>
        <div class="button">
          <input type="submit" name="videos_upload" value="Update" >
        </div>
      </form>
    </div>
  </div>

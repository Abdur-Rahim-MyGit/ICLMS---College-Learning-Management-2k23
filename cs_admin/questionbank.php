...
<body>
      ...
      <?php
        ...
        ?>
     <a href="addquestion.php" class="btn btn-dark mb-2" style="margin-left: 528px; margin-top:80px; background-color : rgba(227 216 253 / 35%);">Add New</a>
                ...
                <table id="example" class="table table-striped"> <br>
                    ...
                    <?php
                        ...
                        <tr >
                            ...
                            <td class="d-flex">
                                <a href="editquestionbank.php?id=<?php echo $row['id'] ?>" class="link-light mt-2"><i class="fa-solid fa-pen-to-square fs-6 me-3"></i></a>
                                <form action="deletequestion.php" method="POST">
                                    <input type="hidden" name="delete_id" value="<?php echo $row['id'];?>">
                                    <input type="hidden" name="delete_question_pdf" value="<?php echo $row['pdf'];?>">
                                    <!-- <a href="deletestaff.php?id=<?php echo $row['id'] ?>" class="link-light"><i class="fa-solid fa-trash fs-6 me-3"></i></a> -->
                                    <button type="submit" name="del_question_pdf" class="btn link-light"><i class="fa-solid fa-trash fs-6 me-3"></i></button>
                                </form>
                            </td>
                        </tr>
                        <?php        

  ...
  <?php require 'partials/_nav.php'?>
    ...
    <?php require 'partials/top_nav.php'?>
     ...
     <?php
        ...
        ?>
     <a href="addstaff.php" class="btn btn-dark mb-2" style="margin-left: 528px; background-color : rgba(227 216 253 / 35%);">Add New</a>
                ...
                <table id="example" class="table table-striped"> <br>
                    ...
                    <?php
                        ...
                        <tr >
                            ...
                            <td class="d-flex">
                                <a href="editstaff.php?id=<?php echo $row['id'] ?>" class="link-light mt-2"><i class="fa-solid fa-pen-to-square fs-6 me-3"></i></a>
                                <form action="deletestaff.php" method="POST">
                                    <input type="hidden" name="delete_id" value="<?php echo $row['id'];?>">
                                    <input type="hidden" name="delete_staff_img" value="<?php echo $row['image'];?>">

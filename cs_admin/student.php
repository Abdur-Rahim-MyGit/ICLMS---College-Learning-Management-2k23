  ...
  <?php require 'partials/_nav.php'?>
    ...
    <?php require 'partials/top_nav.php'?>
     ...
     <?php
            if(isset($_GET['msg'])) {
                $msg = $_GET['msg'];
                echo '<div class="alert alert-dismissible fade show" style="background-color: rgb(255,255,255);" role="alert">
                '.$msg.'
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
              </div>';
            }
        ?>
     <a href="addstudent.php" class="btn btn-dark mb-2" style="margin-left: 528px; background-color : rgba(227 216 253 / 35%);">Add New</a>
                ...
                <table id="example" class="table table-striped"> <br>
                    ...
                    <?php
                        ...
                        <tr >
                            ...
                            <td ><img src="photo/<?php echo $row['image'];?>"
                            ...
                            <!-- <td>
                                <a href="editstudent.php?id=<?php echo $row['id'] ?>" class="link-light"><i class="fa-solid fa-pen-to-square fs-6 me-3"></i></a>
                                <a href="deletestudent.php?id=<?php echo $row['id'] ?>" class="link-light"><i class="fa-solid fa-trash fs-6 me-3"></i></a>
                            </td> -->
                            <td class="d-flex">
                                <a href="editstudent.php?id=<?php echo $row['id'] ?>" class="link-light mt-2"><i class="fa-solid fa-pen-to-square fs-6 me-3"></i></a>
                                <form action="deletestudent.php" method="POST">
                                    <input type="hidden" name="delete_id" value="<?php echo $row['id'];?>">
                                    <input type="hidden" name="delete_student_img" value="<?php echo $row['image'];?>">
                                    <!-- <a href="deletestaff.php?id=<?php echo $row['id'] ?>" class="link-light"><i class="fa-solid fa-trash fs-6 me-3"></i></a> -->
                                    <button type="submit" name="del_student_img" class="btn link-light"><i class="fa-solid fa-trash fs-6 me-3"></i></button>
                                </form>
                            </td>
                        </tr>
                        <?php        

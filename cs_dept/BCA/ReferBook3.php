      ...
      <?php require 'partials/_nav.php'?>
        ...
        <br><br><br><br>
            ...
            <?php
                        ...
                        $sql = "SELECT * from `books` where `group`='computer application' and `year`='III year'";
                        $result = mysqli_query($conn, $sql);
                        while($row = mysqli_fetch_assoc($result)){
                            ?>
        <a href="../../cs_admin/Pdf/<?php echo $row['pdf']?>"><img class="imgbook"src="Imgs/one1.png" alt="" ></a> 
        <?php        
                    }
                ?>
        </div>

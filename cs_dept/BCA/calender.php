...
<?php require 'partials/_nav.php'?>
    ...
    <?php require 'partials/top_nav.php'?>
            <div class="calen container my-4 mt-4" style="border: none;">
                <div class="calen hero">
                    <div id="calendar"></div>
                </div>
            </div>
                ...
                $('#calendar').evoCalendar({
                    ...
                    calendarEvents: [
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            ?>
                        {
                            id: '<?php echo $row['id']?>', // Event's ID (required)
                            name: "<?php echo $row['name']?>", // Event name (required)
                            date: "<?php echo $row['date']?>", // Event date (required)
                            description: "<?php echo $row['description']?>",
                            type: "<?php echo $row['type']?>", // Event type (required)

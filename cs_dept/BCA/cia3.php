...
<body>
        ...
        <?php require 'partials/top_nav.php'?>
            ...
            <?php
                ...
                $sql = "SELECT * from `cia` where `group`='computer application' and `year`='III year'";
                $result = mysqli_query($conn, $sql);
                while($row = mysqli_fetch_assoc($result)){
                     ?>
                        <iframe class="lectvid" src="../../cs_admin/Pdf/<?php echo $row['pdf'];?>"  frameborder="0"></iframe>
                    <?php        
                    }
                ?>
        </div>
        <footer>
          <iframe class="ifrafootcia" src="Foot/index.html" frameborder="0"></iframe>
        </footer>

    ...
    <?php require 'partials/_nav.php'?>
        ...
        <br><br><br>
            <div class="container" style="color:  rgb(255, 255, 255);">
              <!-- <h2 class="mt-4">Video Lectures</h2> -->
              <br><br>
            <section class="vidlects">
            <?php
                        require 'partials/_dbconnect.php';
                        $sql = "SELECT * from `videos` where `group`='computer application' and `year`='III year'";
                        $result = mysqli_query($conn, $sql);
                        while($row = mysqli_fetch_assoc($result)){
                            ?>
                    <video class="lectvids" src="../../cs_admin/Video/<?php echo $row['video']?>" width="30%" poster="Video/Sample2.png" controls ></video>
                      &nbsp;&nbsp;&nbsp;
                      <?php        
                    }
                ?>
        ...
        <footer>
          <iframe class="ifrafootlects" src="Foot/index.html" frameborder="0"></iframe>
        </footer>
